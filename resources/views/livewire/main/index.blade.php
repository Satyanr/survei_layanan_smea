    ...
    <div class="row text-center">
        <div class="col">
            <form wire:submit.prevent="store" enctype="multipart/form-data">
                <div class="row text-center">
                    <div class="col">
                        <label class="form-label"><strong> Tentang </strong></label>
                    </div>
                </div>
                    ...
                    <div class="row my-3">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="input"
                                    placeholder="Sertakan Lantai, Nomor/Nama Ruangan"
                                    class="form-control @error('tempat') is-invalid @enderror" wire:model='tempat'
                                    required>
                                @error('tempat')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                ...
                <div class="row">
                    <div class="col-auto text-center mt-2" style="margin-left: auto">
                        <button type="submit" class="btn btn-primary d-flex m-auto mt-4"
                            wire:loading.attr="disabled" wire:target='bukti_foto'>Kirimkan</button>
                    </div>
                </div>
                @error('tentang')
