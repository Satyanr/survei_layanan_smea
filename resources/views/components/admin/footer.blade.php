<footer class="d-flex flex-wrap justify-content-between align-items-center pt-3 pb-3 mb-0 border-top">
    <div class="col-md-4 ps-3 d-flex align-items-center">
        ...
        <span class="text-white"><a
                ...
                style="text-decoration: none;" class="text-white">© {{ date('Y') }} SECURE</a></span>
    </div>

    <ul class="nav col-md-4 pe-3 justify-content-end list-unstyled d-flex">
        <li class="ms-3"><a class="text-white" href="https://twitter.com/1ciamis">
                <i class="fa-brands fa-twitter"></i>
            </a></li>
        <li class="ms-3"><a class="text-white" href="https://www.instagram.com/smknegeri1ciamis/">
                <i class="fa-brands fa-instagram"></i>
            </a></li>
        <li class="ms-3"><a class="text-white" href="https://web.facebook.com/profile.php?id=100057109013743">
